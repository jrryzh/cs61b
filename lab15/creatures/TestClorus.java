...
public class TestClorus {
    ...
    public void testReplicate() {
        ...
        replicatedP.move();
        assertEquals(1.97, replicatedP.energy(), 0.01);
        replicatedP.move();
        assertEquals(1.94, replicatedP.energy(), 0.01);
        replicatedP.stay();
        assertEquals(1.93, replicatedP.energy(), 0.01);
        replicatedP.stay();
        assertEquals(1.92, replicatedP.energy(), 0.01);
    }
